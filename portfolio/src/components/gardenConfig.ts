...
export const ASSETS = {
  ...
  catbed:      "/footer/CatBedBlue.webp",
  catfood:     "/footer/catfood.webp",
  plant_arnica:   "/footer/arnica arnika 3.webp",
  plant_cosmo:    "/footer/Cosmo.webp",
  plant_daisy:    "/footer/Daisy.webp",
  plant_lavender: "/footer/Lavender.webp",
  plant_lily:     "/footer/Lily.webp",
  plant_pansy:    "/footer/Pansy.webp",
  plant_tulip:    "/footer/Tulip.webp",
  plant_valerian: "/footer/valerian kozek lekarski.webp",
} as const;
